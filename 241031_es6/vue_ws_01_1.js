...
const modelName = "소나타";
const color = "Blue";
const mileage = 120000;

const info = `내 자동차는 ${modelName}이고, 색상은 ${color}입니다. 오늘까지 ${mileage} 주행했습니다.`;
console.log(info)
...
let text = "안녕하세요. 저는 김싸피 입니다. 잘 부탁드립니다.";

// ssafy라는 내용이 들어있는지를 확인한다.
console.log(text.includes("ssafy"));
// 안녕으로 내용이 시작하는지를 확인한다.
console.log(text.startsWith("안녕"));
// .으로 내용이 끝나는지 확인한다.
console.log(text.endsWith("."));

// 5 Array Methods find 활용
